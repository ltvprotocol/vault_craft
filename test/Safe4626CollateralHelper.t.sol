...
contract Safe4626CollateralHelperTest is Test {
    ...
    function test_FullDepositWithdrawCycle() public {
        // Deposit
        uint256 depositAssets = 100e18;
        uint256 depositShares = helper.safeDepositCollateral(
            vault, 
            depositAssets, 
            owner, 
            depositAssets * 95 / 100
        );
        ...
        // Withdraw
        uint256 withdrawAssets = 50e18;
        uint256 withdrawShares = helper.safeWithdrawCollateral(
            vault,
            withdrawAssets,
            receiver,
            owner,
            withdrawAssets * 105 / 100
        );
    ...
    function test_FullMintRedeemCycle() public {
        ...
        uint256 mintAssets = helper.safeMintCollateral(
            vault,
            mintShares,
            owner,
            mintShares * 105 / 100
        ...
        // Redeem
        uint256 redeemShares = 50e18;
        uint256 redeemAssets = helper.safeRedeemCollateral(
            vault,
            redeemShares,
            receiver,
            owner,
